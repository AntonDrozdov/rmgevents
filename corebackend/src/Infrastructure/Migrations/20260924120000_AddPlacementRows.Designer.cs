...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Entities.GroupTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("CreatedByLoginId")
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CreatedByLoginId");

                    b.ToTable("group_templates", "corebackend");
                });

            modelBuilder.Entity("Application.Entities.GroupTemplateItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("group_template_items", "corebackend");
                });
            ...
            modelBuilder.Entity("Application.Entities.Placement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("DisplayChildrenAsRows")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("display_children_as_rows");
                    b.Property<long>("EventId")
                        .HasColumnType("bigint")
                        .HasColumnName("event_id");
                    ...
                    b.ToTable("placements", "corebackend", t =>
                        {
                            t.HasCheckConstraint("placement_quota_nonnegative", "quota IS NULL OR quota >= 0");
                        });
                });

            modelBuilder.Entity("Application.Entities.PlacementTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("placement_templates", "corebackend");
                });
            ...
            modelBuilder.Entity("Application.Entities.User", b =>
                {
                    ...
                    b.Property<long?>("OrganizationEmployeeId")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Application.Entities.GroupTemplate", b =>
                {
                    b.HasOne("Application.Entities.Login", "CreatedByLogin")
                        .WithMany()
                        .HasForeignKey("CreatedByLoginId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CreatedByLogin");
                });

            modelBuilder.Entity("Application.Entities.GroupTemplateItem", b =>
                {
                    b.HasOne("Application.Entities.GroupTemplateItem", "ParentItem")
                        .WithMany("ChildItems")
                        .HasForeignKey("ParentItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Application.Entities.GroupTemplate", "Template")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Application.Entities.Guest", b =>
                {
                    ...
                    b.HasOne("Application.Entities.Placement", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Application.Entities.Placement", b =>
                {
                    b.HasOne("Application.Entities.Event", null)
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Entities.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Application.Entities.User", b =>
                {
                    ...
                    b.HasOne("Application.Entities.OrganizationEmployee", "OrganizationEmployee")
                        .WithMany()
