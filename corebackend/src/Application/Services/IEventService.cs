...
{
    Task<Entities.Event> CreateEventAsync(long ownerId, string name, string? description, long? logoImageId = null);
    ...
    Task UpdateEventAsync(long eventId, string name, string? description);
