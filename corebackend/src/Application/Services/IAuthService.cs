...
public interface IAuthService
{
    ...
    Task<List<(long EventId, string EventName, string RoleName, DateOnly EventDate, DateTimeOffset CreatedAt, string CreatedByName, long? LogoImageId, bool IsArchived)>> GetAvailableEventsAsync(long loginId);
