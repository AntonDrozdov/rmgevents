...
| Файл | Ответственность |
|---|---|
| `frontend/src/pages/GuestsPage.tsx` | Постраничный список, поиск, фильтры по статусу/категории/меткам, похожие гости в форме создания, CRUD-модалки, загрузка справочников формы, статусные действия, progress bar |
...
| `frontend/src/index.css` | Цвета статусов, категория-стрелка, метки-бирки, hover-кнопка, таблица, поиск, фильтры, пагинация, похожие гости, модалка и progress bar |
